...
function compute()
{
   ...
   document.getElementById("result").innerHTML="If you deposit <div = 'h2'>"+p+"</div>,<br\>at an interest rate of <div = 'h2'>"+r+"%</div><br\>You will receive an amount of <div = 'h2'>"+interest+"</div>,<br\>in the year <div = 'h2'>"+year+"</div><br\>"
